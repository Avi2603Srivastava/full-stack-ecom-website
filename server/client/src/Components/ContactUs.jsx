                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay=".5s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="tel:+916386241635" target="_blank">+91-6386241635</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6 wow fadeIn" data-wow-delay=".5s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="https://wa.me/+916386241635" target="_blank">+91-6386241635</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6 wow fadeIn" data-wow-delay=".7s">
                                <div className="d-flex bg-light p-3 rounded">
                                    ...
                                    <div className="ms-3">
                                        ...
                                        <a className="" href="mailto:avinashsrivastav652@gmail.com" target="_blank">avinashsrivastav652@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
