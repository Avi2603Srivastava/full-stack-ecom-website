                ...
                <div className="container">
                    <div className="d-flex justify-content-between topbar">
                        <div className="top-info">
                            <small className="me-3 text-white-50"><Link to="mailto:avinashsrivastav652@gmail.com" target='_blank' rel='noreferrer' className='text-light'><i className="fas fa-envelope me-2 text-secondary"></i> <span className='d-none d-lg-inline'>avinashsrivastav652@gmail.com</span></Link></small>
                            <small className="me-3 text-white-50"><Link to="tel:+919873848046" target='_blank' rel='noreferrer' className='text-light'><i className="fas fa-phone me-2 text-secondary"></i> <span className='d-none d-lg-inline'>+91-6386241635</span></Link></small>
                            <small className="me-3 text-white-50"><Link to="https://wa.me/+916386241635" target='_blank' rel='noreferrer' className='text-light'><i className="fa fa-whatsapp fs-5 me-2 text-secondary"></i> <span className='d-none d-lg-inline'>+91-6386241635</span></Link></small>
                        </div>
